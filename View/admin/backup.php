	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="position-sticky pt-3">
				...
				<li class="nav-item">
                    <button onclick="loadMain('homeadmin');" style="border: 0;">
                        <span data-feather="home"></span>
                        Home
                    </button>
				</li>
				<li class="nav-item">
					<button onclick="loadMain('account');" style="border: 0;">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <!-- include tat ca chuc nang vao bang cach xu ly js-->
                <?php
