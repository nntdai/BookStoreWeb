<?php
    ...
    if(isset($_GET['send'])){
        if(isset($_GET['cbb'])){
            ...
            if(isset($_GET['text'])){
                if($num==1){
                    $Search_TK=$TaiKhoan_Control->getPhoneSearch_cv($_GET['text'], $_GET['send']);
                }else if($num==2){
                    $Search_TK=$TaiKhoan_Control->getMail_cv($_GET['text'], $_GET['send']);
                }else if($num== 3){
                    $Search_TK=$TaiKhoan_Control->getName_cv($_GET['text'], $_GET['send']);
                }
            }
        }else{
        ...
        if(isset($_GET['cbb'])){
            ...
            if(isset($_GET['text'])){
                $text=$_GET['text'];
                if($num==1){
                    $Search_TK=$TaiKhoan_Control->getPhoneSearch($_GET['text']);
                }else if($num==2){
                    echo "<script>alert('$text')</script>";
                    $Search_TK=$TaiKhoan_Control->getMail($_GET['text']);
                }else if($num== 3){
                    $Search_TK=$TaiKhoan_Control->getName($_GET['text']);
                }
            }
        }
    }
...
<body>
	...
	<?php
        if(isset($_GET["send"]) || isset($_GET['text'])){
