    ...
    <div id="khung_hinh_chitietgiohang">
        <div id="khung_chitietgiohang">
            <div style="margin:10px; text-align: center; height:26px">
                <img src="/BookStoreWeb/Image/close.png" height="25px" width="25px" style="float:right" onclick="close_Detail(<?php echo $ma;?>)">
            </div>
        ...
        <?php
            ...
            foreach ($chitietgio as $dh){       
                echo "<th>".$i."</th>";
                echo "<th><img src='/BookStoreWeb/".$dh['url']."' width=100px height=100px'></th>";
                echo "<th>".$dh['ten']."</th>";
